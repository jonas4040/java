...
public class Receita {
	...
	private Map<String,String> ingrediente_quantidade;
	...
	public Map<String, String> getIngrediente_quantidade() {
		return ingrediente_quantidade;
	}

	public void setIngrediente_quantidade(Map<String, String> ingrediente_quantidade) {
